...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
    ...
    public static String filteSQLStr(String keyword){
	...
	public static String replaceToIn(String str){
		if (isBlank(str)){
			return "";
		}
		if (str.contains(";")){
	...
	public static String genRandomNum(int pwd_len) {
		...
		char[] str = { 'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l', 'm', 'n', 'p', 'q', 'r', 's',
...
//	}
	...
	public static Boolean toBoolean(Object val){
		return Boolean.valueOf(objToStr(val));
	}
     ...
     * @return
     */
    public static String convertInvoiceNo(Object object) {
        if (object == null) {
            return "";
        }
